...
namespace Hombay.Controllers
{
    public class BuyerController : Controller
    {
        ...
        public ActionResult Add_to_Cart1(tbl_Order _Order)
        {
            HomeBeyDBEntities db = new HomeBeyDBEntities();


            var userid = Convert.ToInt32(Session["UserID"]);
            List<User_Bidding> items = db.User_Bidding.Where(x => x.Approve == "Payment" & x.Buyer_Id == userid).ToList();
            ...
            var productname = db.User_Bidding.Where(x => x.Approve == "Payment" & x.Buyer_Id== userid).FirstOrDefault();
            string proName = productname.Item_Name;
            string paymentamount = productname.price;

            var mypaidprice = db.sp_paidItemprice(Convert.ToInt32(Session["UserID"])).ToList();
            Session["mypaid"] = mypaidprice[0];

            string paymentstripe = Session["mypaid"] + "00";
            ...
            StripeConfiguration.ApiKey = "sk_test_51I0UbKGIttDVGBLrOHE2pOo9cLdd0SoyJYeLsixAfgvz7HZNWwcHYYjbZDBuvt4yigH0Fih3BOl9gqxrgfgXtinA000Gz7eN5K";
            ...
            var options = new SessionCreateOptions
            {
              ...
              {
              UnitAmount =(long)Convert.ToDouble(paymentamount),
              Currency = "PKR",
              ProductData = new SessionLineItemPriceDataProductDataOptions
              {
                Name = proName.ToString(),
              },
            ...
            Quantity = 1,
                ...
                Mode = "payment",
                SuccessUrl = "http://localhost:52354/buyer/Thanks",
        ...
        public ActionResult live_Chat(tbl_Chat tbl_, string value)
        {
            ...
            ////string sltresult = db.tbl_Chat.SqlQuery(slt).ToString();


            //var slt = db.tbl_Chat.Count(x => x.Sender_user == value1 || x.Receiver_user== value2 || x.Sender_user==value2 || x.Receiver_user==value1).ToString();
            //int sltresult = Convert.ToInt32(slt);
            ...
            //    var getid = db.tbl_Chat.Where(x => x.Receiver_user == value2).FirstOrDefault();
            //    string getthestring = getid.Sender;




            //    tbl_.Sender = getthestring.ToString();
            ...
            //else if(sltresult <=0)
            //{
            //    tbl_.Sender="GHC"+DateTime.Now.Second;
            //    db.tbl_Chat.Add(tbl_);
            //    db.SaveChanges();
            ...
            //var sltsender = db.tbl_Chat.Where(x => x.Receiver_user == value2).FirstOrDefault();
            //string selectsender = sltsender.Sender;
            ...
            //string query = "SELECT * FROM tbl_Chat WHERE Sender ='"+ selectsender + "'";
        ...
        public ActionResult Add_to_Cart(tbl_Order _Order)
        {
            ...
            var mypaidprice = db.sp_paidItemprice(Convert.ToInt32(Session["UserID"])).ToList();
            Session["mypaids"] = mypaidprice[0];
            string paymentstripes = Session["mypaids"] + "00";
            // UnitAmount = (long)Convert.ToDouble(paymentstripes),
